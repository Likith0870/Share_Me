      ...
      <div className='flex lg:flow-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
              ...
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>
                    use highquality JPG, SVG , PNG, GIF less than 20MB 
                  </p>
                </div>
                <input type="file"
                  name='upload-image'
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          <input 
            ...
            className='outlined-none text-xl sm:text-2xl font-bold border-b-2 border-gray-200 p-2'
          />
          {user && (
          ...
          <input 
            ...
            className='outlined-none text-base sm:text-lg  border-b-2 border-gray-200 p-2'
          />
          <input 
            type='text'
            value = {destination}
